...
public class StudentManagement extends JFrame {
	...
	public  StudentManagement () {
		...
		JButton btnImportdatafromdevice = new JButton("Import Data From Device");
		btnImportdatafromdevice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Import Data From Successfully");
		...
		btnImportdatafromdevice.setForeground(new Color(0, 128, 255));
		btnImportdatafromdevice.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnImportdatafromdevice.setBackground(new Color(255, 255, 255));
		btnImportdatafromdevice.setBounds(361, 244, 198, 25);
		contentPane.add(btnImportdatafromdevice);
		...
		btnAdd.setBounds(387, 81, 117, 48);
		...
		btnSavedata.setForeground(new Color(0, 128, 255));
		btnSavedata.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnSavedata.setBackground(new Color(255, 255, 255));
		btnSavedata.setBounds(387, 174, 117, 25);
